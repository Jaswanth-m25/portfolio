          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="text-lg text-muted-foreground max-w-xl leading-relaxed animate-fade-in animation-delay-200">
                ...
                — a full-stack developer and Computer Science undergraduate at
                IIIT Sri City. I specialize in building scalable web applications
                using React.js, Node.js, Express.js, and MongoDB with modern UI/UX
